        ...
        case HATK:
            switch(facingDirection)
            {
                case LEFT:
                    ...
                    if(xMax < 5.09/xFrames && xMin > 4.22/xFrames && plyTimer->getTicks() > 30){
                    ...
                    else if(xMax < 4.24/xFrames && xMin > 3.22/xFrames && plyTimer->getTicks() > 30){
