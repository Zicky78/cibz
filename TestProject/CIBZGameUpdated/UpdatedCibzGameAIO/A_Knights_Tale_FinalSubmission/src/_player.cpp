        ...
        case DODGE:
            switch(facingDirection)
            {
                case LEFT:
                    ...
                    if(lFlag && (dodgingLimit || !isDodging)){
                        actionTrigger = LWALK;
                    }
                    else if(dodgingLimit || !isDodging)
                        actionTrigger = STAND;
                ...
                case RIGHT:
                    ...
                    if(rFlag && (dodgingLimit || !isDodging)){
                        actionTrigger = RWALK;
                    }
                    else if(dodgingLimit || !isDodging)
                        actionTrigger = STAND;
                ...
                case UP:
                    ...
                    if(uFlag && (dodgingLimit || !isDodging)){
                        actionTrigger = UWALK;
                    }
                    else if(dodgingLimit || !isDodging)
                        actionTrigger = STAND;
                ...
                case DOWN:
                    ...
                    if(dFlag && (dodgingLimit || !isDodging)){
                        actionTrigger = DWALK;
                    }
                    else if(dodgingLimit || !isDodging)
                        actionTrigger = STAND;
