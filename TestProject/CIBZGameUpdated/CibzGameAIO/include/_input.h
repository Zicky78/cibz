...
class _input
{
    public:
        ...
        void mouseDown(_onScreenButtons* btn, _menu* menu, float x, float y, float width, float height);
        ...
        void mouseDown(_player*, _parallax*, float, float, _enemies*, int,  _door*, _particles*);
        void mouseUp(_player*, _parallax*, _enemies*, int, _door*, _particles*);
